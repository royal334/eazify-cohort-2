...
function Footer() {
  return (
     <section id='footer' className="p-4 md:px-0">
          <div className='container px-8 py-18 mx-auto bg-black rounded-2xl '>
               <div className="flex flex-col md:flex-row gap-16">
                    <div className="w-3/4">
                         <img src="/public/images/logo-2.png" alt="logo" className="" />
                    </div>
               ...
               <div className="my-10 border-t-2 border-b-2 py-6 border-gray-400 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <FooterDetails title="OPENING HOURS" details="Mon to Sat: 8.00am - 6:00pm  Sun: Closed" icon={<Clock3 size={28} strokeWidth={1.75}  color="#0071FF"/>} />
